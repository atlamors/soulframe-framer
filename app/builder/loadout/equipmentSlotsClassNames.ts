...
export const EQUIPMENT_SLOT_CLASS_NAMES = {
  helm: {
    default:
      "group group/equipment relative z-10 col-start-1 row-start-2 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line/42 bg-loadout-card px-2.5 py-2 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-2 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-2 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-1 row-start-2 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line-bright/70 bg-loadout-card-hover px-2.5 py-2 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-2 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-2 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
  cuirass: {
    default:
      "group group/equipment relative z-10 col-start-1 row-start-3 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line/42 bg-loadout-card px-2.5 py-2 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-3 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-3 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-1 row-start-3 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line-bright/70 bg-loadout-card-hover px-2.5 py-2 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-3 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-3 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
  leggings: {
    default:
      "group group/equipment relative z-10 col-start-1 row-start-4 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line/42 bg-loadout-card px-2.5 py-2 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-4 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-4 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-1 row-start-4 flex min-h-24 w-full cursor-pointer items-center justify-self-start gap-2.75 border border-frame-line-bright/70 bg-loadout-card-hover px-2.5 py-2 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-4 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-1 max-tablet:row-start-4 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
  talisman: {
    default:
      "group group/equipment relative z-10 col-start-2 row-start-2 flex min-h-24 w-full cursor-pointer items-center justify-self-end gap-2.75 border border-frame-line/42 bg-loadout-card px-2.5 py-2 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-5 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-2 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-2 row-start-2 flex min-h-24 w-full cursor-pointer items-center justify-self-end gap-2.75 border border-frame-line-bright/70 bg-loadout-card-hover px-2.5 py-2 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 compact-desktop:max-wide-desktop:gap-1.75 compact-desktop:max-wide-desktop:px-2 compact-desktop:max-wide-desktop:py-1.5 tablet:max-compact-desktop:order-5 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-2 max-tablet:grid max-tablet:min-h-20.5 max-tablet:w-full max-tablet:max-w-none max-tablet:grid-cols-[auto_minmax(0,1fr)] max-tablet:items-center max-tablet:gap-1.25 max-tablet:px-1.5 max-tablet:py-1.25 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
  "weapon-1": {
    default:
      "group group/equipment relative z-10 col-start-2 row-start-3 flex min-h-24 w-full cursor-pointer flex-col items-center justify-self-end gap-0 border border-frame-line/42 bg-loadout-card p-0 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover focus-within:border-frame-line-bright/65 aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 tablet:max-compact-desktop:order-6 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-3 max-tablet:min-h-0 max-tablet:w-full max-tablet:max-w-none max-tablet:gap-0 max-tablet:p-0 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-2 row-start-3 flex min-h-24 w-full cursor-pointer flex-col items-center justify-self-end gap-0 border border-frame-line-bright/70 bg-loadout-card-hover p-0 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 focus-within:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 tablet:max-compact-desktop:order-6 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-3 max-tablet:min-h-0 max-tablet:w-full max-tablet:max-w-none max-tablet:gap-0 max-tablet:p-0 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
  "weapon-2": {
    default:
      "group group/equipment relative z-10 col-start-2 row-start-4 flex min-h-24 w-full cursor-pointer flex-col items-center justify-self-end gap-0 border border-frame-line/42 bg-loadout-card p-0 text-left text-ink shadow-loadout-card transition-colors duration-150 ease-out hover:border-frame-line-bright/65 hover:bg-loadout-card-hover focus-within:border-frame-line-bright/65 aria-expanded:border-frame-line-bright/70 aria-expanded:bg-loadout-card-hover aria-expanded:shadow-loadout-card-active compact-desktop:max-wide-desktop:min-h-22 tablet:max-compact-desktop:order-7 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-4 max-tablet:min-h-0 max-tablet:w-full max-tablet:max-w-none max-tablet:gap-0 max-tablet:p-0 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
    active:
      "group group/equipment relative z-10 col-start-2 row-start-4 flex min-h-24 w-full cursor-pointer flex-col items-center justify-self-end gap-0 border border-frame-line-bright/70 bg-loadout-card-hover p-0 text-left text-ink shadow-loadout-card-active transition-colors duration-150 ease-out hover:border-frame-line-bright/80 focus-within:border-frame-line-bright/80 aria-expanded:border-frame-line-bright/70 compact-desktop:max-wide-desktop:min-h-22 tablet:max-compact-desktop:order-7 tablet:max-compact-desktop:max-w-none max-tablet:inset-auto max-tablet:col-start-2 max-tablet:row-start-4 max-tablet:min-h-0 max-tablet:w-full max-tablet:max-w-none max-tablet:gap-0 max-tablet:p-0 focus-visible:outline-none focus-visible:shadow-focus motion-reduce:transition-none",
  },
...
export const EQUIPMENT_SLOT_ART_CLASS_NAMES = {
  standard: {
    empty:
      "flex size-19.5 flex-none items-center justify-center overflow-hidden border-r border-frame-line/18 bg-aura-gold compact-desktop:max-wide-desktop:size-16 max-tablet:size-14.5 max-tablet:border-r",
    filled:
      "flex size-19.5 flex-none items-center justify-center overflow-hidden border-r border-frame-line/18 bg-aura-gold compact-desktop:max-wide-desktop:size-16 max-tablet:size-14.5 max-tablet:border-r",
  },
  weapon: {
    empty:
      "flex size-19.5 flex-none items-center justify-center overflow-hidden border-r border-frame-line/18 bg-aura-gold compact-desktop:max-wide-desktop:size-16 max-tablet:size-14.5 max-tablet:overflow-visible max-tablet:border-r max-tablet:bg-transparent",
    filled:
      "flex size-19.5 flex-none items-center justify-center overflow-hidden border-r border-frame-line/18 bg-aura-gold compact-desktop:max-wide-desktop:size-16 max-tablet:size-14.5 max-tablet:overflow-visible max-tablet:border-r max-tablet:bg-transparent",
  },
} as const satisfies Record<
...
export const EQUIPMENT_SLOT_DEFENSE_STATS_CLASS_NAME =
  "mt-1.5 grid grid-cols-3 gap-1.5 border-t border-frame-line/18 pt-1.25 compact-desktop:max-wide-desktop:gap-1 max-tablet:col-start-2 max-tablet:row-span-2 max-tablet:row-start-1 max-tablet:mt-0 max-tablet:grid-cols-1 max-tablet:gap-0.25 max-tablet:border-t-0 max-tablet:pt-0";
...
export const EQUIPMENT_SLOT_STANDARD_FOOTER_CLASS_NAMES = {
  requirement:
    "absolute inset-x-0 bottom-0 flex min-h-8.5 items-center justify-start border-t border-frame-line/28 bg-surface-deep/35 px-2 py-1 compact-desktop:max-wide-desktop:min-h-7 compact-desktop:max-wide-desktop:px-1.5 compact-desktop:max-wide-desktop:py-0.75 max-tablet:min-h-8 max-tablet:px-2 max-tablet:py-1",
  talisman:
    "absolute inset-x-0 bottom-0 flex min-h-8.5 items-center justify-end border-t border-frame-line/28 bg-surface-deep/35 px-2 py-1 compact-desktop:max-wide-desktop:min-h-7 compact-desktop:max-wide-desktop:px-1.5 compact-desktop:max-wide-desktop:py-0.75 max-tablet:min-h-8 max-tablet:px-2 max-tablet:py-1",
} as const satisfies Record<"requirement" | "talisman", string>;

export const EQUIPMENT_SLOT_REQUIREMENT_CLASS_NAMES = {
  met: "inline-flex items-center gap-1 font-sans text-xs font-semibold text-ink-faint",
  unmet:
    "inline-flex items-center gap-1 font-sans text-xs font-semibold text-danger",
} as const satisfies Record<"met" | "unmet", string>;

export const EQUIPMENT_SLOT_REQUIREMENT_ICON_CLASS_NAME =
  "size-3.5 flex-none object-contain";
...
export const EQUIPMENT_SLOT_WEAPON_SUMMARY_MOBILE_CLASS_NAME =
  "hidden font-sans font-medium text-ink-soft max-tablet:col-start-2 max-tablet:row-span-2 max-tablet:row-start-1 max-tablet:flex max-tablet:flex-col max-tablet:items-end max-tablet:gap-0.25 max-tablet:whitespace-nowrap max-tablet:text-right max-tablet:text-3xs max-tablet:leading-tight";

export const EQUIPMENT_SLOT_ENCHANTMENT_STRIP_CLASS_NAME =
  "flex min-h-8.5 w-full items-center justify-end gap-1 border-t border-frame-line/28 bg-surface-deep/35 pt-0.75 pr-2 pb-1.25 pl-2 compact-desktop:max-wide-desktop:min-h-7 compact-desktop:max-wide-desktop:pt-0.5 compact-desktop:max-wide-desktop:pr-1.5 compact-desktop:max-wide-desktop:pb-1 compact-desktop:max-wide-desktop:pl-1.5 max-tablet:min-h-8 max-tablet:justify-end max-tablet:gap-1 max-tablet:px-2 max-tablet:py-1";
