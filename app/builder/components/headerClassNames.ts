...
export const HEADER_CLASS_NAMES = {
  ...
  actions:
    "relative z-20 col-span-3 flex items-center justify-self-end gap-2 tablet:max-compact-desktop:gap-1.5 max-tablet:col-span-1 max-tablet:col-start-2 max-tablet:row-start-1",
  nonMenuActions: "contents",
  nonAlertActions: "contents",
  alertTrigger:
    "group relative inline-flex min-h-11 min-w-11 cursor-pointer items-center justify-center border border-line bg-transparent p-0 text-ink-soft transition-colors duration-150 ease-out hover:border-line-bright hover:text-gold-bright focus-visible:outline-none focus-visible:shadow-focus compact-desktop:max-wide-desktop:min-h-10 compact-desktop:max-wide-desktop:min-w-10 max-tablet:size-11 max-tablet:border-0 motion-reduce:transition-none",
  alertTriggerActive:
...
export const BUILD_NAME_CONTROL_CLASS_NAMES = {
  header: {
    default:
      "col-span-6 flex w-full max-w-130 min-w-0 items-center justify-self-center gap-0 [--build-name-frame-cap:24px] compact-desktop:max-wide-desktop:[--build-name-frame-cap:22px] max-tablet:hidden max-tablet:[--build-name-frame-cap:22px] max-narrow:[--build-name-frame-cap:20px]",
    editing:
      "col-span-6 flex w-full max-w-130 min-w-0 items-center justify-self-center gap-0 [--build-name-frame-cap:24px] compact-desktop:max-wide-desktop:[--build-name-frame-cap:22px] max-tablet:hidden max-tablet:[--build-name-frame-cap:22px] max-narrow:[--build-name-frame-cap:20px]",
  },
  drawer: {
